...
cabeçalho('Versão 0.7b')

user = linecache.getline('configb.txt',15)
password = linecache.getline('configb.txt',16)
...
entrada = linecache.getline('configb.txt',7)
stop_l = linecache.getline('configb.txt',8)
stop_w = linecache.getline('configb.txt',9)
gale_c = linecache.getline('configb.txt',10)
